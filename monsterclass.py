...
monster_list_1stage = []
monster_list_1stage_snake = [Snake() for i in range(9)]
monster_list_1stage_bat = [Bat() for i in range(12)]
monster_list_1stage_lizard = [Horned_Lizard() for i in range(4)]

monster_place_1stage = [[33, 18], [22, 23], [4, 41], [31, 45], # lizard
...
monster_list_2stage = []
monster_list_2stage_bat = [Bat() for i in range(21)]

monster_place_2stage = [[4, 2], [5, 2], [6, 2], [7, 2], [8, 2], [9, 2], [10, 2], [11, 2], [12, 2], [20, 5], [29, 1], [10, 11], [5, 33], [6, 40], [9, 40], [15, 40], [3, 42], [2, 43], [1, 44], [34, 41], [44, 40]]   # bat

monster_list_2stage +=  monster_list_2stage_bat
